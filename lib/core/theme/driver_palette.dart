...
class DriverPalette {
  ...
  static DriverPalette byId(String id) =>
      all.firstWhere((p) => p.id == id, orElse: () => laffah);

  // ── Laffah Leaf — light brand (default) ──────────────────
  static const DriverPalette laffah = DriverPalette(
    id: 'laffah',
    brightness: Brightness.light,
    leaf: Color(0xFFAFE3BD),
    primary: Color(0xFF28834F),
    primaryDark: Color(0xFF1B653B),
    primarySoft: Color(0xFFE8F5EC),
    primaryGlass: Color(0xCC28834F),
    accent: Color(0xFF2C8150),
    accentDark: Color(0xFF216A40),
    accentSoft: Color(0xFFE8F5EC),
    asphalt: Color(0xFF34453B),
    asphaltDark: Color(0xFF203229),
    pinBlue: Color(0xFF2D7FD3),
    pinRed: Color(0xFFE0524C),
    pinOrange: Color(0xFFF2A03D),
    background: Color(0xFFF6F9F6),
    surface: Color(0xFFFFFFFF),
    surfaceAlt: Color(0xFFF1F6F2),
    surfaceDim: Color(0xFFE4EDE6),
    textPrimary: Color(0xFF1C3024),
    textSecondary: Color(0xFF4C6053),
    textMuted: Color(0xFF5E7165),
    hint: Color(0xFF5E7165),
    success: Color(0xFF28834F),
    warning: Color(0xFFF2A03D),
    danger: Color(0xFFE0524C),
    info: Color(0xFF2D7FD3),
    routeFull: Color(0xFF34453B),
    routeGo: Color(0xFF28834F),
    routeReturn: Color(0xFFF2A03D),
    routeShadow: Color(0x66DDE8DA),
    driveDone: Color(0xFF9FD493),
    driveCurrent: Color(0xFF2D7FD3),
    driveAhead: Color(0xFF28834F),
    optional: Color(0xFFF2A03D),
    optionalOff: Color(0xFF9AA6A0),
    border: Color(0xFFDFE9E1),
    borderStrong: Color(0xFFB8CDBE),
    divider: Color(0xFFE8EFEA),
  );
